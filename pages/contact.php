				...
				<section class="our-store section inner-left-xs">
					...
					<ul class="list-unstyled operation-hours">
						<li class="clearfix">
							...
							<span class="pull-right hours">9-6 PM</span>
						</li>
						<li class="clearfix">
					...
					<h3>Career</h3>
					<p>If you're interested in employment opportunities at MediaCenter, please email us: <a href="mailto:contact@yourstore.com">contact@gotirur.com</a></p>
				</section><!-- /.our-store -->
			</div><!-- /.col -->
